...
import com.example.digipro.databinding.ActivityRecordBinding
    ...
    private fun captureVideo() {
        ...
        val contentValues = ContentValues().apply {
            ...
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
                put(MediaStore.Video.Media.RELATIVE_PATH, "Movies/DigitalProtect-Video")
            }
        }
            ...
            .start(ContextCompat.getMainExecutor(this)) { recordEvent ->
                when(recordEvent) {
                    is VideoRecordEvent.Start -> {
                        Toast.makeText(baseContext, "Start Recording", Toast.LENGTH_LONG).show()
                    }
